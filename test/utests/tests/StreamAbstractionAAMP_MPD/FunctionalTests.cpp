...
protected:
	...
	public:
		...
		void CallProcessEarlyAvailablePeriod(ManifestDownloadResponsePtr mpdDnldResp)
		{
			ProcessEarlyAvailablePeriod(mpdDnldResp);
		}
...
TEST_F(StreamAbstractionAAMP_MPDTest, ProcessEarlyAvailablePeriodDetectsOnlyEarlyNonVssPeriods)
{
	static const char *manifest =
		R"(<?xml version="1.0" encoding="utf-8"?>
<MPD xmlns="urn:mpeg:dash:schema:mpd:2011" xmlns:cenc="urn:mpeg:cenc:2013" type="dynamic" minimumUpdatePeriod="PT2S" availabilityStartTime="2026-02-26T10:00:00Z" minBufferTime="PT2S">
	...
	EXPECT_CALL(*g_mockAampUtils, aamp_GetCurrentTimeMS())
		.WillRepeatedly(Return(startTimeMS));
	EXPECT_CALL(*g_mockAampConfig, IsConfigSet(eAAMPConfig_DetectEarlyAvailablePeriod))
		.WillRepeatedly(Return(true));
	mPrivateInstanceAAMP->rate = AAMP_NORMAL_PLAY_RATE;

	mStreamAbstractionAAMP_MPD->CallProcessEarlyAvailablePeriod(response);
...
<MPD xmlns="urn:mpeg:dash:schema:mpd:2011" xmlns:cenc="urn:mpeg:cenc:2013" type="dynamic" minimumUpdatePeriod="PT2S" availabilityStartTime="2026-02-26T10:00:00Z" minBufferTime="PT2S">
	...
	EXPECT_CALL(*g_mockAampUtils, aamp_GetCurrentTimeMS()).WillRepeatedly(Return(startTimeMS));
	EXPECT_CALL(*g_mockAampConfig, IsConfigSet(eAAMPConfig_DetectEarlyAvailablePeriod)).WillRepeatedly(Return(true));
	mPrivateInstanceAAMP->rate = AAMP_NORMAL_PLAY_RATE;
...
TEST_F(StreamAbstractionAAMP_MPDTest, ProcessEarlyAvailablePeriodQueuesContentProtectionWithExpectedParameters)
{
	static const char *manifest =
		R"(<?xml version="1.0" encoding="utf-8"?>
<MPD xmlns="urn:mpeg:dash:schema:mpd:2011" xmlns:cenc="urn:mpeg:cenc:2013" type="dynamic" minimumUpdatePeriod="PT2S" availabilityStartTime="2026-02-26T10:00:00Z" minBufferTime="PT2S">
